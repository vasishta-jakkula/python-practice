...
while True:
    ...
    if input1 == "2":
        ...
        if exploration_level == 0:
            print("you can only gather wood,stone, and food")
        if exploration_level == 1:
            print("you can only gather wood,stone,food, and gold")
        if exploration_level == 2:
            print("you can only gather wood,stone,food,gold, and emeralds")
        if exploration_level == 3:
            print("you can only gather wood,stone,food,gold,emeralds, and diamonds")
